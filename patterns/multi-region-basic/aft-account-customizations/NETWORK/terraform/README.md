...
| aws\_vpc\_endpoint\_services | "List with the VPC endpoint services to be centralized in the network account." Example: ```[ "ec2", "ec2messages", "ssm", "ssmmessages" ]``` | `list(string)` | `[]` | no |
