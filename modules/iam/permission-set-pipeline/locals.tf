...
locals {
  ...
  codeconnection_arn    = local.vcs.is_github ? aws_codeconnections_connection.github[0].arn : local.vcs.is_github_enterprise ? aws_codeconnections_connection.githubenterprise[0].arn : null
